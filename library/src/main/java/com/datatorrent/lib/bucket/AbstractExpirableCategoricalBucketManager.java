 ...
 *
 */
public abstract class AbstractExpirableCategoricalBucketManager<T> extends AbstractBucketManagerOptimized<T>
{
  // Defaults
  ...
  public AbstractExpirableCategoricalBucketManager()
  {
    super();
  ...
  @Deprecated
  @Override
  public AbstractExpirableCategoricalBucketManager<T> cloneWithProperties()
  {
    return null;
  }
  ...
  private static final transient Logger logger = LoggerFactory
      .getLogger(AbstractExpirableCategoricalBucketManager.class);
}
