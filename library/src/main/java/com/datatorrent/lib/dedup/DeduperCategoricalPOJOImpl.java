...
/**
 * An implementation of Deduper which uses a Categorical Bucket Manager (
 * {@link ExpirableCategoricalBucketManagerPOJOImpl} ). This implementation takes POJO as input.
 *
 * @displayName Deduper
 * @tags dedup, pojo
 */
public class DeduperCategoricalPOJOImpl extends AbstractDeduperOptimized<Object, Object>
{
  ...
  public void processTuple(Object event)
  {
    if (getter == null) {
      ...
      getter =
          PojoUtils.createGetter(fqcn, ((ExpirableCategoricalBucketManagerPOJOImpl)bucketManager).getKeyExpression(),
              Object.class);
    }
  ...
  private static final transient Logger logger = LoggerFactory.getLogger(DeduperCategoricalPOJOImpl.class);
