...
/**
 * An implementation of Deduper which uses a Time Based BucketManager ({@link ExpirableTimeBasedBucketManagerPOJOImpl}
 * ). This implementation takes POJO as input.
 *
 * @displayName Deduper
 * @tags dedup, pojo
 */
public class DeduperTimeBasedPOJOImpl extends AbstractDeduperOptimized<Object, Object>
{
  ...
  public void processTuple(Object event)
  {
    if (getter == null) {
      ...
      getter =
          PojoUtils.createGetter(fqcn, ((ExpirableTimeBasedBucketManagerPOJOImpl)bucketManager).getKeyExpression(),
              Object.class);
    }
  ...
  private static final transient Logger logger = LoggerFactory.getLogger(DeduperTimeBasedPOJOImpl.class);
