...
public class IngestionUtils
{
  ...
  public static void createAppDataConnections(DAG dag, String topic, String schemaFile,
      OutputPort<List<Map<String, Object>>> data)
  {
    ...
    if (!StringUtils.isEmpty(gatewayAddress)) {
      ...
      AppDataSnapshotServerMap snapshotServer = dag.addOperator("SnapshotServer_" + topic,
      ...
      PubSubWebSocketAppDataResult wsResult = dag.addOperator("QueryResult_" + topic,
      ...
      dag.addStream("Result_" + topic, snapshotServer.queryResult, queryResultPort)
