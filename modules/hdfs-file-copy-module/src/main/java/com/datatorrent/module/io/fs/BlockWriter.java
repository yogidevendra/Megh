...
import com.datatorrent.module.io.fs.FilterStreamProviders.*;
import com.datatorrent.module.io.fs.CompressionFilterStream.*;
  ...
  Partitioner<BlockWriter>
{
  ...
  public final transient DefaultOutputPort<ExtendedFileBlockMetadata> blockMetadataOutput = new DefaultOutputPort<ExtendedFileBlockMetadata>();
  ...
  public void endWindow()
  {
    ...
    for (BlockMetadata.FileBlockMetadata blockMetadata : blockMetadatas) {
      ExtendedFileBlockMetadata eBlockMetadata = new ExtendedFileBlockMetadata(blockMetadata);
      try {
        finalizeFile(Long.toString(blockMetadata.getBlockId()));
      } catch (IOException e) {
        throw new RuntimeException(e);
      }
      blockMetadataOutput.emit(eBlockMetadata);
    }
  ...
  private void setFilterStreamTimingCounters()
  {
    if(filterStreamProvider != null){
      for (BlockMetadata.FileBlockMetadata blockMetadata : blockMetadatas) {
        ...
        eBlockMetadata.setCompressionTime(timeTakenNanos);
      }
    }
  }
