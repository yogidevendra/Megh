...
public interface OutputFileMetaData
{
  ...
  {
    public void writeTo(FileSystem blocksFS, String blocksDir, OutputStream outputStream) throws IOException, BlockNotFoundException;
   ...
   */
  public static class OutputFileBlockMetaData extends ExtendedFileBlockMetadata implements OutputBlock{
    ...
    public void writeTo(FileSystem appFS, String blocksDir,OutputStream outputStream, 
                         long offset, long length)throws IOException, BlockNotFoundException{
