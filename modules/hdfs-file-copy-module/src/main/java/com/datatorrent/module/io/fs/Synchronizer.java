...
public class Synchronizer extends BaseOperator
{
  ...
  public final transient DefaultInputPort<ExtendedFileBlockMetadata> blocksMetadataInput = new DefaultInputPort<ExtendedFileBlockMetadata>()
  {
    @Override
    public void process(ExtendedFileBlockMetadata blockMetadata)
    {
